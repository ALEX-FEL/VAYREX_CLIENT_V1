...
import { x as resolveManifestAssetLink, u as resolveManifestCssLink, y as getManifestScriptFormat, k as rootRouteId, z as getNormalizedURL, A as getOrigin, C as attachRouterServerSsrUtils, D as defineHandlerCallback, E as createSerializationAdapter, F as createRawStreamRPCPlugin, i as invariant, g as isNotFound, m as isRedirect, G as isResolvedRedirect, H as mergeHeaders, I as executeRewriteInput, J as defaultSerovalPlugins, K as makeSerovalPlugin, s as getScriptPreloadAttrs, L as getStylesheetHref } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DoMcb3-8.mjs");
